...
// $commonP = array_intersect($products1, $products2);// will check common with key not values
$commonProducts = array_intersect_assoc( $products1, $products2 ); // will check common with key and values

print_r( $common ); // [0]=>2 [2]=>12 [3]=>7
print_r( $commonProducts ); // [t] => tv
